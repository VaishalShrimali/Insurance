                            ...
                            <div class="card-body">
                                <div class="col-md-12 row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" class="form-control @error('e_date') is-invalid @enderror" name="e_date" value="{{old('e_date',$policy[0]['expire_date'])}}" id="e_date" placeholder="Expire of Date">
                                        @error('e_date')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" class="form-control @error('r_date') is-invalid @enderror" name="r_date" value="{{old('r_date',$policy[0]['renewal_date'])}}" id="phone" placeholder="Renewal of Date">
                                        @error('r_date')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <!-- <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('Beneficiaries') is-invalid @enderror" name="Beneficiaries" value="{{old('Beneficiaries',$policy[0]['beneficiaries'])}}" id="Beneficiaries" placeholder="Enter Beneficiaries">
                                        @error('Beneficiaries')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div> -->
                                    ...
                                    <div class="form-group col-md-6" id="v1" style="visibility :  visible">
                                        ...
                                        <input type="text" class="form-control @error('vehicle') is-invalid @enderror" name="vehicle" value="{{old('vehicle',$policy[0]['vehicle'])}}" id="vehicle" placeholder="Enter Vehicle">
                                        @error('vehicle')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12 row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control @error('premium') is-invalid @enderror" name="premium" value="{{old('premium',$policy[0]['premium'])}}" id="premium" placeholder="Enter premium">
                                        @error('premium')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <!--    <input type="text" class="form-control @error('amount') is-invalid @enderror" name="amount" value="{{old('amount',$policy[0]['amount'])}}" id="amount" placeholder="Enter Amount">-->
                                    <!--    @error('amount')-->
                                    <!--    <p class="text-danger">{{ $message }}</p>-->
                                    <!--    @enderror-->
                                    <!--</div>-->
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="date" class="form-control @error('payment_date') is-invalid @enderror" name="payment_date" value="{{old('payment_date',$policy[0]['payment_date'])}}" id="payment_date" placeholder="Payment Date">
                                        @error('payment_date')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-3">
                                        ...
                                        <select name="mode" id="mode" class="form-control @error('mode') is-invalid @enderror">
                                            <option value="">Select Type</option>
                                            <option <?php if ($policy[0]['payment_mode'] == 'Online') {
                                                        echo 'selected';
                                ...
                                <div class="col-md-12 row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="file" class="form-control @error('docs') is-invalid @enderror" name="docs[]" multiple value="{{old('docs')}}" id="docs">
                                        @error('docs')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="name">Special Remark</label>
                                        <textarea name="remark" id="remark" cols="30" rows="1" class="form-control @error('remark') is-invalid @enderror" placeholder="Enter Remark"> {{$policy[0]['remark']}} </textarea>
                                        @error('remark')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
