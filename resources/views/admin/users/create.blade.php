                            ...
                            <div class="card-body">
                                <div class="col-md-12 row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('f_name') is-invalid @enderror" name="f_name" value="{{old('f_name')}}" id="f_name" placeholder="Enter First Name">
                                        @error('f_name')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('l_name') is-invalid @enderror" name="l_name" value="{{old('l_name')}}" id="l_name" placeholder="Enter Last Name">
                                        @error('l_name')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <!-- <div class="form-group col-md-6">
                                        ...
                                        <input type="date" class="form-control @error('dob') is-invalid @enderror" name="dob" value="{{old('dob')}}" id="phone" placeholder="DoB">
                                        @error('dob')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div> -->
